...
public enum VALUE_DESERIALIZER_CONFIG {
    ...
    STRING_DESERIALIZER("org.apache.kafka.common.serialization.StringDeserializer.class");

    private final String value;

    VALUE_DESERIALIZER_CONFIG(String actualValue) {
        value = actualValue;
    }
}
